...
// worker/node_modules/hono/dist/middleware/serve-static/path.js
...
// worker/node_modules/hono/dist/middleware/serve-static/index.js
var ENCODINGS = {
  br: ".br",
  zstd: ".zst",
  gzip: ".gz"
...
// worker/node_modules/hono/dist/adapter/cloudflare-workers/utils.js
...
// worker/node_modules/hono/dist/adapter/cloudflare-workers/serve-static.js
...
// worker/node_modules/hono/dist/adapter/cloudflare-workers/serve-static-module.js
var module = /* @__PURE__ */ __name((options) => {
  return serveStatic2(options);
}, "module");

// worker/node_modules/hono/dist/helper/websocket/index.js
var WSContext = class {
  static {
...
// worker/node_modules/hono/dist/adapter/cloudflare-workers/websocket.js
...
// worker/src/index.ts
var app = new Hono2();
var getBaseUrl = /* @__PURE__ */ __name((c) => "https://atlangrove.aroloyeayodele61.workers.dev", "getBaseUrl");
var toAbsoluteUrl = /* @__PURE__ */ __name((c, relativeUrl) => {
  if (!relativeUrl) return "";
  if (relativeUrl.startsWith("http")) return relativeUrl;
  const baseUrl = getBaseUrl(c);
  return `${baseUrl}${relativeUrl}`;
}, "toAbsoluteUrl");
var transformPost = /* @__PURE__ */ __name((c, post) => {
  if (!post) return null;
  return {
    id: post.id,
    _id: post.id,
...
admin.post("/login", async (c) => {
  try {
    ...
    const payload = { id: user.id, username: user.username, exp: Math.floor(Date.now() / 1e3) + 60 * 60 * 24 };
...
admin.post("/blogs", async (c) => {
  ...
  const { meta } = await c.env.DB.prepare("INSERT INTO blogs (title, content, author_id, status, image_url) VALUES (?, ?, ?, ?, ?)").bind(title, content, author_id, status, image_url).run();
...
app.use("/*", module({ root: "./" }));
app.get("*", module({ path: "./index.html" }));
