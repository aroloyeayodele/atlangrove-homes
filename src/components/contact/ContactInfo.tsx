    ...
    <div className="bg-gray-50 rounded-lg p-6 sm:p-8 border border-gray-200">
      ...
      <div className="space-y-6">
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-600">+234 806 655 8355</p>
            <p className="text-gray-600">+234 806 172 0146</p>
          </div>
        </div>
      ...
      <div className="mt-8 bg-white p-4 rounded-lg border border-gray-200">
        ...
        <p className="text-gray-600 text-sm mb-4">
          Follow us on social media for property updates, market trends, and more.
        </p>
