...
const testimonials: Testimonial[] = [
  ...
  content: 'Atlangrove Homes guided me through the entire process of acquiring investment property in Lagos. Their market knowledge and professionalism are unmatched.',
  ...
  content: "As a first-time buyer, I was nervous about the process, but the team at Atlangrove Homes made everything simple and transparent. I couldn't be happier with my new home!",
  ...
  content: 'Working with Atlangrove Homes has significantly expanded our development portfolio. Their consulting services and market insights have been invaluable to our success.',
      ...
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-600 slide-up animate-delay-200">
            Hear what our clients have to say about their experience working with Atlangrove Homes.
          </p>
        </div>
